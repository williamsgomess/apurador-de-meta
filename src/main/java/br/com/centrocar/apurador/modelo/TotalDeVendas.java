...
/**
 * Classe filha da super classe {@link Venda} Responsável pelo total de todas as
 * vendas. {@link SemValorFiscal}, {@link NotaFiscal},
 * {@link NotaFiscalConsumidor}. </b> A soma geral destas classe resulta no
 * valor desta.
 * 
...
public class TotalDeVendas extends Venda {

	/**
	 * Construtor sem parâmetros com {@code super()};
	 */
	 ...
	 */
	public TotalDeVendas(BigDecimal total) {
		super(total);
