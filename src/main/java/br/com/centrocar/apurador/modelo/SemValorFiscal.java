...
/**
 * Classe filha da super classe {@link Venda} Responsável por todas as vendas
 * sem valor fiscal.
 * 
 ...
 * @see Venda
 */
public class SemValorFiscal extends Venda {
	 ...
	 */
	public SemValorFiscal(BigDecimal total) {
		super(total);
